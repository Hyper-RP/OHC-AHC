...
resource "aws_route_table_association" "private" {
  ...
  route_table_id = aws_route_table.private[var.environment == "staging" ? 0 : count.index].id
}

# ============================================
# VPC ENDPOINTS - Cost Optimized Strategy
# ============================================

# S3 Gateway Endpoint - ALWAYS FREE ✅
resource "aws_vpc_endpoint" "s3" {
  ...
  tags = {
    ...
    Note = "FREE - Always use this for S3 traffic"
  }
}

# NOTE: We're NOT using Interface Endpoints for ECR, Secrets Manager, CloudWatch
# because at $7.30/endpoint/month, they're not worth it for this app's usage.
# The NAT Gateway handles these services at lower total cost for our traffic pattern.
