...
export const AnnualHealthPharmacistRequestPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPrescription = async () => {
      if (!prescriptionId) {
        navigate('/annual-health-pharmacist', { replace: true });
        return;
      }
  ...
  const handleDispense = async () => {
    ...
    try {
      ...
      navigate('/annual-health-pharmacist');
    } catch (err) {
          ...
          <>
            <section className={pageStyles.hero}>
              ...
              <div className={pageStyles.heroActions}>
                <Button type="button" variant="outline-secondary" onClick={() => navigate('/annual-health-pharmacist')}>
                  Back
                </Button>
              </div>
            </section>
            ...
            <section className={pageStyles.summaryGrid}>
              ...
              <div className={pageStyles.summaryCard}>
                ...
                <span className={pageStyles.summaryValue}>{selectedPrescription.visit.employee_id || selectedPrescription.visit.employee?.employee_code || 'N/A'}</span>
              </div>
              <div className={pageStyles.summaryCard}>
                ...
                <Card className={pageStyles.panel}>
                  ...
                  <div className={pageStyles.formStack}>
                    ...
                    <div className={pageStyles.noteBox}>
                      After dispensing, the annual health checkup visit status will be updated to Completed.
                    </div>
                  </div>
                </Card>
